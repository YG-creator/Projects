      ...
      <div class="board-hospital-wrap">
        <div class="board-hospital">
          ...
          <div class="tab-area">
            ...
            <label for="tab1">병원 정보</label>
            <input type="radio" id="tab2" name="tab" />
            <label for="tab2">진료 정보</label>
            <input type="radio" id="tab3" name="tab" />
            <label for="tab3">병원 리뷰</label>
            <div class="content cont1">
              <p>위치 : <%=vo.getHp_addr() %></p>
              <p>과 : <%=vo.getHp_subject() %></p>
            </div>
        ...
        <div class="btn-wrap">
       	  <a href="./eval_form?hosp_name=<%=vo.getHp_name()%>&location=<%=vo.getHp_addr()%>&hpid=<%=vo.getHpid()%>">리뷰 작성</a>
