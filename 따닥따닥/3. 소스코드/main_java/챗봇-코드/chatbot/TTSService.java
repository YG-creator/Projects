...
public class TTSService {
	public String clovaTextToSpeech(String filePathName, String language) {
		 String clientId = "8cmadra1ha";//애플리케이션 클라이언트 아이디값";
	        String clientSecret = "B93JUK34fk29oFgBt8ZCBhkjXdYqpWPedbz8PMBz";//애플리케이션 클라이언트 시크릿값";
	        ...
	        try {
	            ...
	            if(responseCode==200) { // 정상 호출
	                ...
	                File f = new File("/opt/tomcat/apache-tomcat-9.0.56/webapps/mp3/"+voiceFileName); //반환값(저장되는 파일명)
	                ...
	                Runtime.getRuntime().exec("chmod-R 755 "+f);
	                is.close();
	            } else {  // 오류 발생
