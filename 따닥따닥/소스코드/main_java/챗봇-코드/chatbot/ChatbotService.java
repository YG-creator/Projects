...
import org.json.simple.JSONArray;//여기 바뀜
import org.json.simple.JSONObject;//여기도 바뀜
...
public class ChatbotService {
	...
	public String main(String voiceMessage) {
		...
		String apiURL = "https://52247890437a45f3966d41c100f9d17b.apigw.ntruss.com/custom/v1/6027/5d6e4c1a75b8f098badd4bc10ea600e839dd6c1ad1f563722dc8a158d88d98ec";
		String secretKey = "Q2V4V3ZEbEZUYXp2RVhjUFJvemFYeVlvZnFEbFNMbnc=";
        ...
        try {
            ...
            if(responseCode==200) { // Normal call
                ...
                System.out.println("return "+chatbotMessage);  // 전달받은 결과 출력
	...
	public static String jsonToString(String jsonStr) {
		String resultText = "";
		System.out.println("rt "+jsonStr);
		try {
			// 추출할 오브젝트 
			JSONObject jsonObj = new JSONObject();//여기 JSONObject jsonObj = new JSONObject(jsonStr);
...
//=> userId is a unique code for each chat user, not a fixed value, recommend use UUID. use different id for each user could help you to split chat history for users.
            ...
            bubbles_array.add(bubbles_obj); //bubbles_array.put(bubbles_obj);
