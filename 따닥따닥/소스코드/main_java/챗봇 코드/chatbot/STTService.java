...
public class STTService {
	public String clovaSpeechToText(String filePathName, String language) {
		String clientId = "63u36nz7tv";             // Application Client ID";
        String clientSecret = "50ZBFDaiiFFrOHSQJLhpgSXI06qgUaWxa6v8IzrG";     // Application Client Secret";
        String result = "";
...
//                resultToFileSave(result);
	...
	public void resultToFileSave(String result) {
		...
		String filePathName = "/opt/tomcat/apache-tomcat-9.0.56/webapps/mp3/"+"stt_" + fileName + ".txt";
	...
	public String jsonToString(String jsonStr) {
		...
		try {
			JSONObject jsonObj = new JSONObject(); //JSONObject jsonObj = new JSONObject(jsonStr);
